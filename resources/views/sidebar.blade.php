  ...
  <body>
    <div x-data="setup()" x-init="$refs.loading.classList.add('hidden');" @resize.window="watchScreen()">
      <div class="flex h-screen antialiased text-gray-900 bg-blue-gray-100 dark:bg-dark dark:text-light">
        ...
        <div
          x-ref="loading"
          class="fixed inset-0 z-50 flex items-center justify-center text-2xl font-semibold text-white bg-green-500"
        >
          Loading.....
        </div>
        ...
        <div class="flex flex-shrink-0 transition-all">
          ...
          <nav
            aria-label="Options"
            class="fixed inset-x-0 bottom-0 flex flex-row-reverse items-center justify-between px-4 py-2 bg-white border-t sm:hidden shadow-t border-green-100 rounded-t-3xl"
          >
            <!-- Menu button -->
            <button
              @click="(isSidebarOpen && currentSidebarTab == 'linksTab') ? isSidebarOpen = false : isSidebarOpen = true; currentSidebarTab = 'linksTab'"
              class="p-2 transition-colors rounded-lg shadow-md hover:bg-green-800 hover:text-white focus:outline-none focus:ring focus:ring-green-500 focus:ring-offset-white focus:ring-offset-2"
              :class="(isSidebarOpen && currentSidebarTab == 'linksTab') ? 'text-white bg-green' : 'text-gray-500 bg-white'"
            >
            ...
            <div class="relative flex items-center flex-shrink-0 p-2" x-data="{ isOpen: false }">
              <button
                ...
                class="transition-opacity rounded-lg opacity-80 hover:opacity-100 focus:outline-none focus:ring focus:ring-green-500 focus:ring-offset-white focus:ring-offset-2"
              >
                <img
          ...
          <nav
            aria-label="Options"
            class="z-20 flex-col items-center flex-shrink-0 hidden w-16 py-4 bg-white border-r-2 shadow-md sm:flex rounded-tr-3xl rounded-br-3xl border-green-100"
          >
            <!-- Logo -->
            ...
            <div class="flex flex-col items-center flex-1 p-2 space-y-4">
              ...
              <button
                @click="(isSidebarOpen && currentSidebarTab == 'linksTab') ? isSidebarOpen = false : isSidebarOpen = true; currentSidebarTab = 'linksTab'"
                class="p-2 transition-colors rounded-lg shadow-md hover:bg-green-800 hover:text-white focus:outline-none focus:ring focus:ring-green-500 focus:ring-offset-white focus:ring-offset-2"
                :class="(isSidebarOpen && currentSidebarTab == 'linksTab') ? 'text-white bg-green-500' : 'text-gray-500 bg-white'"
              >
                <span class="sr-only">Toggle sidebar</span>
                <svg
                  aria-hidden="true"
              ...
              <button
                ...
                class="p-2 transition-colors rounded-lg shadow-md hover:bg-green-800 hover:text-white focus:outline-none focus:ring focus:ring-green-500 focus:ring-offset-white focus:ring-offset-2"
                :class="(isSidebarOpen && currentSidebarTab == 'messagesTab') ? 'text-white bg-green-500' : 'text-gray-500 bg-white'"
              >
              ...
              <button
                ...
                class="p-2 transition-colors rounded-lg shadow-md hover:bg-green-800 hover:text-white focus:outline-none focus:ring focus:ring-green-500 focus:ring-offset-white focus:ring-offset-2"
                :class="(isSidebarOpen && currentSidebarTab == 'notificationsTab') ? 'text-white bg-green-500' : 'text-gray-500 bg-white'"
              >
          ...
          <div
            ...
            x-show="isSidebarOpen"
            class="fixed inset-y-0 left-0 z-10 flex-shrink-0 w-64 bg-white border-r-2 shadow-lg sm:left-16 border-green-100 rounded-tr-3xl rounded-br-3xl sm:w-72 lg:static lg:w-64"
          >
            <nav x-show="currentSidebarTab == 'linksTab'" aria-label="Main" class="flex flex-col h-full">
              ...
              <div class="flex-1 px-4 space-y-2 overflow-hidden hover:overflow-auto">
                <a href="#" class="flex items-center w-full space-x-2 text-white rounded-lg bg-green-500">
                  <span aria-hidden="true" class="p-2 rounded-lg bg-green-800">
                    <svg
                      class="w-6 h-6"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                ...
                <a
                  href="#"
                  class="flex items-center space-x-2 transition-colors rounded-lg group text-green-500 hover:bg-green-500 hover:text-white"
                >
                  <span
                    aria-hidden="true"
                    class="p-2 transition-colors rounded-lg group-hover:bg-green-800 group-hover:text-white"
                  >
                    <svg
                      class="w-6 h-6"
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="flex-shrink-0 p-4 mt-10">
                <div class="p-2 space-y-6 rounded-lg bg-blue-gray-100">
                  <img class="-mt-10" src="./assets/images/undraw_web_developer_p3e5.svg" alt="Not Important" />
                  <p class="text-sm text-green-500">
                    Use our <span class="text-base text-green-800">Premium</span> features now! <br />
                  </p>
                  <button
                    class="w-full px-4 py-2 text-center text-white transition-colors rounded-lg bg-green-500 hover:bg-green-800 focus:outline-none focus:ring focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-blue-gray-100"
                  >
                    Upgrade to pro
                  </button>
                </div>
