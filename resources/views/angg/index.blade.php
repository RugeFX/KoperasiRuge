...
<div class="w-full flex justify-center">
    <h1 class="text-3xl font-bold mb-8 text-green-600 ml-0">Anggota</h1>
</div>
    <div class="mr-2 bg-gray-50 p-4 rounded-xl border border-slate-200">
        <div class="flex gap-2 w-1/3 mb-2">
            ...
            <a href="{{ route('angg.create') }}" class="flex items-center gap-2 text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:border-green-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition duration-300 ease-in-out">
                            ...
                            <table class="min-w-full">
                                <thead class="bg-green-500 border-b">
                                    <tr>
                                        ...
                                        <th class="text-sm font-bold text-white px-6 py-4 text-left">No Anggota</th>
                                        <th class="text-sm font-bold text-white px-6 py-4 text-left">Nama</th>
                                        <th class="text-sm font-bold text-white px-6 py-4 text-left">Jenis Kelamin</th>
                                        <th class="text-sm font-bold text-white px-6 py-4 text-left">No Telpon</th>
                                        <th class="text-sm font-bold text-white px-6 py-4 text-left">Action</th>
                                    </tr>
                                </thead>
                                @foreach($angg as $anggotafor)
                                <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                    <td class="text-sm text-green-600 font-light px-6 py-4 whitespace-nowrap">{{ ++$i }}</td>
                                    <td class="text-sm text-green-600 font-light px-6 py-4 whitespace-nowrap">{{ $anggotafor->noAnggota }}</td>
                                    <td class="text-sm text-green-600 font-light px-6 py-4 whitespace-nowrap">{{ $anggotafor->namaAnggota }}</td>
                                    <td class="text-sm text-green-600 font-light px-6 py-4 whitespace-nowrap">{{ $anggotafor->jKelamin }}</td>
                                    <td class="text-sm text-green-600 font-light px-6 py-4 whitespace-nowrap">{{ $anggotafor->noTelpon }}</td>
