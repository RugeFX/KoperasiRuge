...
<div class="w-full flex justify-center">
    <h1 class="text-3xl font-bold mb-8 text-green-600 ml-0">Edit Jenis Simpanan</h1>
</div>
...
<form action="{{ route('jen.update', $jen->id) }}" method="POST">
@csrf
@method('PUT')
    ...
    <div class="mr-2 bg-gray-50 p-4 rounded-xl border border-slate-200">
        <div class="flex justify-center">
            <div class="grid grid-cols-2 mx-10 gap-y-2">
                ...
                <div class="form-item">
                    <input type="text" name="idJenis"  placeholder="ID Jenis" value="{{ $jen->idJenis }}" class="form-control
                    block
                    w-full
                    px-3
                    py-1.5
                ...
                <div class="form-item">
                    <input type="text" name="jenisSimpanan"  placeholder="Jenis Simpanan" value="{{ $jen->jenisSimpanan }}" class="form-control
                    block
                    w-full
                    px-3
                    py-1.5
                ...
                <div class="form-item">
                    <input type="text" name="jumlah"  placeholder="Jumlah" value="{{ $jen->jumlah }}" class="form-control
                    block
                    w-full
                    px-3
                    py-1.5
